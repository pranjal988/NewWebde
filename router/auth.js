...
router.put('/recentbatches/:id', async(req, res) => {
    ...
    const { date, mmyy, time, th, mentorName, mentorPosition, scholarshippercent, scholarshipRupee, limitedseats } = req.body;

    if (!date || !mmyy || !time || !th || !mentorName || !mentorPosition || !scholarshippercent || !scholarshipRupee || !limitedseats) {
...
router.post('/sales', async(req, res) => {
    ...
    try {
        ...
        const User = new Sales({ image, name });
